...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        default = "microsoft/deberta-v3-small", metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
...
def main():
    ...
    if "deberta" in model_args.model_name_or_path:
        mname = "microsoft/deberta-v3-base"
    ...
    if "csqa2" in data_args.train_file:
        ...
        n_choices = 5
    elif "ARC" in data_args.train_file:
        n_choices = 4
    elif 'race' in data_args.train_file:
        n_choices = 4
    elif 'exams' in data_args.train_file:
        n_choices = 4
